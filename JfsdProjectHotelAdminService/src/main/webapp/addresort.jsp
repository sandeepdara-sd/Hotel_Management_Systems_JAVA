...
<head>
    ...
    <title>Serene Stay | Add Resort</title>
...
<body>
    ...
    <div class="add-user-form">
        ...
        <h2>Add Resort</h2>
        <form method="post" action="insertresort">
            <label for="hotelName">Resort Name:</label>
            <input type="text" id="hotelName" name="resortname" required>

            <label for="location">Resort Price:</label>
            <input type="text" id="location" name="resortprice" required>
